...
int mains() {
	...
	long x = 1;
	long y = 1;
	FILE *f = fopen("/home/khan/Desktop/captcha/captcha8.png", "rb");
	...
	if (png_ptr == NULL) {
		printf("ERROR png_ptr == NULL");
		return -1;
	}
	png_infop info_ptr = png_create_info_struct(png_ptr);

	if (info_ptr == NULL) {
		printf("ERROR info_ptr == NULL");
		return -1;
	}
